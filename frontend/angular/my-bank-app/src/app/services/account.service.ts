...
export class AccountService {
  ...
  getAccountsByCustomerId(customerId: string): Observable<AccountResponseDTO> {
    ...
    console.log('User id in getAccountsByCustomerId:', customerId); // Debugging userId retrieval
  ...
  getCustomerIdByUserId(): Observable<any> {
    ...
    const token = localStorage.getItem('auth-token');
    console.log('Token in getCustomerIdByUserId:', token); // Debugging token retrieval
    console.log('User id in getCustomerIdByUserId:', userId); // Debugging userId retrieval
